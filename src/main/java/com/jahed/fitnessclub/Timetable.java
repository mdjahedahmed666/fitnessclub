...
public class Timetable {
    ...
    public static void CreateTimeTable(){
        ...
        allTimetables.add(new Timetable(3,new Lesson("Bodysculpt","Sunday",350),1));
        allTimetables.add(new Timetable(4,new Lesson("Zumba","Sunday",250),1));

        allTimetables.add(new Timetable(5,new Lesson("Zumba","Saturday",250),1));
        allTimetables.add(new Timetable(6,new Lesson("Bodysculpt","Saturday",350),1));
        allTimetables.add(new Timetable(7,new Lesson("Yoga","Sunday",200),1));
        allTimetables.add(new Timetable(8,new Lesson("Spin","Sunday",300),1));

        allTimetables.add(new Timetable(9,new Lesson("Spin","Saturday",300),1));
        allTimetables.add(new Timetable(10,new Lesson("Zumba","Saturday",250),1));
        allTimetables.add(new Timetable(11,new Lesson("Bodysculp","Sunday",350),1));
        allTimetables.add(new Timetable(12,new Lesson("Yoga","Sunday",200),1));

        allTimetables.add(new Timetable(13,new Lesson("Yoga","Saturday",200),1));
        allTimetables.add(new Timetable(14,new Lesson("Bodysculp","Saturday",350),1));
        allTimetables.add(new Timetable(15,new Lesson("Zumba","Sunday",250),1));
        allTimetables.add(new Timetable(16,new Lesson("Spin","Sunday",300),1));
        ...
        allTimetables.add(new Timetable(19,new Lesson("Bodysculpt","Sunday",350),2));
        allTimetables.add(new Timetable(20,new Lesson("Zumba","Sunday",250),2));

        allTimetables.add(new Timetable(21,new Lesson("Zumba","Saturday",250),2));
        allTimetables.add(new Timetable(22,new Lesson("Bodysculpt","Saturday",350),2));
        allTimetables.add(new Timetable(23,new Lesson("Yoga","Sunday",200),2));
        allTimetables.add(new Timetable(24,new Lesson("Spin","Sunday",300),2));

        allTimetables.add(new Timetable(25,new Lesson("Spin","Saturday",300),2));
        allTimetables.add(new Timetable(26,new Lesson("Zumba","Saturday",250),2));
        allTimetables.add(new Timetable(27,new Lesson("Bodysculp","Sunday",350),2));
        allTimetables.add(new Timetable(28,new Lesson("Yoga","Sunday",200),2));

        allTimetables.add(new Timetable(29,new Lesson("Yoga","Saturday",200),2));
        allTimetables.add(new Timetable(30,new Lesson("Bodysculp","Saturday",350),2));
        allTimetables.add(new Timetable(31,new Lesson("Zumba","Sunday",250),2));
        allTimetables.add(new Timetable(32,new Lesson("Spin","Sunday",300),2));
